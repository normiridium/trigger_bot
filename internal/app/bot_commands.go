...
func defaultBotCommands() []tgbotapi.BotCommand {
	out := []tgbotapi.BotCommand{
		...
		{Command: cmdYandexMusicSearch, Description: "Поиск трека в Yandex Music"},
		{Command: cmdVKMusicSearch, Description: "Поиск трека в VK"},
		{Command: cmdSoundCloudSearch, Description: "Поиск трека в SoundCloud"},
		...
		{Command: cmdSummary, Description: "Сводка чата за последние сутки"},
	}
