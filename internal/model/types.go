...
type Trigger struct {
	...
	CaseSensitive bool
	ActionType    ActionType         // send|send_sticker|delete|gpt_prompt|gpt_image|search_image|spotify_music_audio|music_audio|yandex_music_audio|media_link_audio|media_tiktok_download|media_x_download
